...
describe BowlingGame do
  ...
  context 'when a strike is thrown' do
    it 'records the frame score as 10 plus the number of pins knocked down in the next two rolls' do
      game.roll(10)
      game.roll(7)
      game.roll(1)
  ...
  context 'in the event of a perfect game' do
    it 'records bonus rolls at the end of the game' do
